...
The latest set of longitudinal data were collected on September 30th, 2025. See [The Data](#the-data) for all the details!
...
#### The Data Dictionary (2025-09-10 to Current)
...
> **Note**: Between Between 2025-09-10 and 2025-09-26 (inclusive), the values for `stateless_reset_token` in transport parameters were logged in base 10. Starting on 2025-09-30, the values for `stateless_reset_token` were logged in base 16 (consistent with other "long" values [e.g., `initial_source_connection_id`]).
